...
sport field, and so the wave is able to travel continuously around the arena; in discontinuous seating arrangements,
...
public class MexicanWave {
    public static String[] wave(String str) {
        ...
        String[] lowerStrSplitted = str.toLowerCase().split("");
        ...
        for (int i = 0; i < lowerStrSplitted.length; i++) {
            ...
            if(Character.isLetter(str.charAt(i))) {
                ...
                newList.add(String.valueOf(strBuilder));
            }
...
/*
other solution - function approach
